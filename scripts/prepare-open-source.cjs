...
const files=['README.md','README.zh-TW.md','LICENSE','.gitignore','parser.test.cjs','exporter.test.cjs','i18n.test.cjs','dist/index.html','dist/style.css','dist/i18n.js','dist/parser.js','dist/exporter.js','dist/app.js','scripts/build-standalone.cjs','scripts/prepare-open-source.cjs'];
